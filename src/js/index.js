...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () => {
        if(window.innerWidth < 450) {
            window.scrollTo({top: 0,  behavior:  'somooth'});
...
function removerSelecaoDoPersonagem() {
    const personagemsSelecionado = document.querySelector('.selecionado');
    personagemsSelecionado.classList.remove('selecionado');
}
